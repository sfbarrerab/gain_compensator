...
void to_attenuations_page(){
	current_screen = ATTENUATION_PAGE;
}
...
void init_main_page(){
	...
	mainpage.attenuations_page_button = new Button(0, 2*MENU_BTN_HEIGHT, MENU_BTN_WIDTH, MENU_BTN_HEIGHT, "Atten.", to_attenuations_page, NULL);
